            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand logo_h" href="{{url('/')}}">Sistem Perizinan Usaha</a>
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav justify-content-center">
                                ...
                                @guest
                                <li style="margin-left: 42%;" class="nav-item"><a class="nav-link" href="{{url('/produk-unggulan')}}">Beranda</a></li>
                              ...
                              <li class="nav-item" style="display: {{Auth::user()->role=="admin" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/usaha-telah-terverifikasi')}}" >Usaha</a>
                              </li> 

                              <li class="nav-item" style="display: {{Auth::user()->role=="humas" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/lihat-pemohon')}}" >Pemohon Usaha</a>
                              </li> 
                              <li class="nav-item" style="display: {{Auth::user()->role=="wirausahawan" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/usaha')}}">Usaha</a>
                              </li>  

                              <li class="nav-item" style="display: {{Auth::user()->role=="wirausahawan" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/profil-saya')}}" >Profil</a>
                              </li> 
                              <li class="nav-item" style="display: {{Auth::user()->role=="humas" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/profil')}}" >Profil</a>
                              </li> 
                              <li class="nav-item" style="display: {{Auth::user()->role=="humas" ? "block" : "none"}}">
                                <a class="nav-link" href="{{url('/usaha-telah-verif')}}" >Usaha Terverifikasi</a>
                              </li> 
                              @yield('notifikasi')
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                            ...
                            <ul class="nav navbar-nav navbar-right ml-3">
                                <li class="nav-item">
                                <a class="primary_btn text-uppercase" href="{{url('/logout')}}">Logout</a>
                            </li>
                            </ul>
                            @endauth
                            @guest
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item">
                                    <a href="#myModal" class="primary_btn text-uppercase" data-toggle="modal">Login</a></li>

                            </ul>
                            <ul class="nav navbar-nav navbar-right ml-3">
                                <li class="nav-item"><a href="{{url('/registrasi-wirausahawan')}}" class="primary_btn text-uppercase">Registrasi</a></li>
                            </ul>
                            @endguest
                        </div>
                    </div>
