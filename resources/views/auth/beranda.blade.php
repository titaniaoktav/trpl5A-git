...
<head>
  ...
  <link rel="stylesheet" href="{{asset('template/vendors/flaticon/flaticon.css')}}">
  <!-- main css -->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <a class="navbar-brand logo_h" href="index.html"><img src="{{asset('template/img/logo.png')}}" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item active"><a class="nav-link" href="price.html">Pricing</a></li>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="left_features">
            <img class="img-fluid" src="{{asset('template/template/img/f-img.png')}}" alt="">
          </div>
        </div>
          ...
          <div class="owl-carousel brand-carousel">
            ...
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo1.png')}}" alt="">
              </div>
            </div>
            <!-- single-brand -->
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo2.png')}}" alt="">
              </div>
            </div>
            <!-- single-brand -->
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo3.png')}}" alt="">
              </div>
            </div>
            <!-- single-brand -->
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo4.png')}}" alt="">
              </div>
            </div>
            <!-- single-brand -->
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo5.png')}}" alt="">
              </div>
            </div>
            <!-- single-brand -->
            <div class="single-brand-item d-table">
              <div class="d-table-cell">
                <img src="{{asset('template/img/brands/logo6.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
